...
const ContentPreview: Component<{
    ...
    return (
                <div class="w-full flex-auto hover:shadow-lg">
                    <div class="rounded-t-lg bg-white">
                        <div class="relative flex justify-center rounded-lg bg-secondary-200">

                            <div class="flex justify-center duration-500">
                                <a href="#">
                                    <img src="https://images.unsplash.com/photo-1517487881594-2787fef5ebf7?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=735&amp;q=80" alt="" />
                                </a>
                                <div
                                    class="absolute h-full w-full opacity-0 transition delay-200 ease-in-out hover:opacity-100">
                                    <ul class="absolute top-auto right-0 bottom-0 left-0 flex items-center gap-3 bg-gray-600 bg-opacity-70 p-4">
                                        <li>
                                            <a href="#" class="flex items-center justify-center gap-2 text-white">
                                                60
                                    ...
                                    <a href="#"
                                       class="absolute top-3 right-4 left-auto rounded bg-white p-2 text-gray-400 hover:opacity-100">
                                        <svg width="15" class="icon-16" viewBox="0 0 24 24" fill="currentcolor"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4"
